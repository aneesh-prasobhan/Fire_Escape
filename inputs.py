...
stickman_start_compartment = 2        # Should be under "number_of_compartments_per_floor - 1" and >=0
...
compartment_rectangle_color = color_BLACK
clicked_compartment_counter_color = color_BLACK
clicked_compartment_counter_box_color = color_SKY_BLUE
no_PATH_FOUND_color = color_RED
place_stickman_text_color = color_BLACK
set_fire_text_color = color_BLACK
path_found_text_color = color_DARK_GREEN
